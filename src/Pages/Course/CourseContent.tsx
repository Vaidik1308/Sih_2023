...
const CourseContent = () => {
  return (
    ...
    >
        ...
        <section className='flex gap-2 border-[4px] w-[90%] p-4 rounded-lg border-solid border-gray-400 border-opacity-[0.4]  items-center'>
            <article className='w-[70%] flex flex-col gap-4'>
                ...
                <button className='bg-[#43D02C] w-[55%] p-2 text-white text-[1rem] font-[600]'>
                    Enroll Now
                </button>
            </article>
            <article>
