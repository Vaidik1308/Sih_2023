...
const SingleNgo = ({data}) => {
    console.log(data);
    
  return (
    <section className=' h-[30vh] flex gap-2 border-[4px] w-[90%] p-4 rounded-lg border-solid border-gray-400 border-opacity-[0.4]  items-center bg-gray-100'>
            <article className='w-[70%] flex flex-col gap-4'>
                ...
                <div className='w-full flex flex-col gap-1'>
                    ...
                    <p className='text-[0.75rem]'>{data.shortdesc}</p>
                </div>
                <Link to={`/features/ruralaid/ngofunding/${data.id}`}>
